...
Loads the trained Random Forest model (baseline, accuracy 72.08%)
+ preprocessor + label encoder, and exposes a clean predict() interface
for the Streamlit app layer.
"""
...
class CreditScoreInferenceEngine:
    """
    Loads saved artefacts (Random Forest baseline) and performs
    single inference for the Streamlit app.
